...
// Nouvelle route pour la visualisation 3D et le dessin IA
app.get('/visualisation', (req, res) => {
    res.sendFile(path.join(__dirname, 'public', 'visualisation.html'));
});

// Nouvelle route pour les agents de conversation IA
app.get('/agents-ia', (req, res) => {
    res.sendFile(path.join(__dirname, 'public', 'agents-ia.html'));
});

// Nouvelle route pour les outils CLI
app.get('/outils-cli', (req, res) => {
    res.sendFile(path.join(__dirname, 'public', 'outils-cli.html'));
});

// Nouvelle route pour les rapports (si vous la développez)
app.get('/rapports', (req, res) => {
    res.sendFile(path.join(__dirname, 'public', 'rapports.html'));
});
